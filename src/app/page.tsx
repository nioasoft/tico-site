    ...
    <div className="font-sans">
      ...
      <section className="container py-14 border-t border-foreground/10">
        <div className="mx-auto max-w-4xl px-2">
          <h2 className="text-3xl sm:text-5xl font-extrabold mb-4 text-center">בעולם שמחפש לריב, אני מציע לפתור בעיות.</h2>
      ...
      <section className="container py-14 border-t border-foreground/10">
        <div className="mx-auto max-w-4xl px-2">
          <h2 className="text-3xl sm:text-5xl font-extrabold mb-4 text-center">מאיזון עמודות לאיזון בין אנשים.</h2>
          <p className="text-foreground/70 max-w-prose mx-auto text-center">
      ...
      <section className="container py-14 border-t border-foreground/10">
        <div className="mx-auto max-w-4xl px-2">
          <h2 className="text-3xl sm:text-5xl font-extrabold mb-4 text-center">זה לא מתאים לכל אחד.</h2>
          <p className="text-foreground/70 max-w-prose mx-auto text-center">
